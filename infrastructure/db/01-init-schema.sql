...
CREATE TABLE IF NOT EXISTS character_sheets (
  ...
  avatar_url      TEXT,
  notes           TEXT,
  -- UI / Specialized storage
  personality     JSONB NOT NULL DEFAULT '{"traits": "", "ideals": "", "bonds": "", "flaws": ""}',
  attacks         JSONB NOT NULL DEFAULT '[]',
  spellcasting_info JSONB NOT NULL DEFAULT '{"ability": "INT", "dc": 10, "bonus": 0, "class": ""}',
  money           JSONB NOT NULL DEFAULT '{"cp": 0, "sp": 0, "ep": 0, "gp": 0, "pp": 0}',
  created_at      TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at      TIMESTAMPTZ NOT NULL DEFAULT NOW(),
